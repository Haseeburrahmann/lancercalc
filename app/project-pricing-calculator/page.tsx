    ...
    <>
      ...
      <div className="min-h-screen">
        ...
        <EmailCapture
          ...
          heading="Free Freelance Pricing Tips — In Your Inbox"
          subheading="Rate strategies, negotiation guides, and finance tips for freelancers — free, straight to your inbox."
        />
