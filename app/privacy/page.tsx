      ...
      <section className="bg-white py-14 md:py-20">
        <div className="max-w-[860px] mx-auto px-4 sm:px-6">
          ...
          <div className="flex items-center gap-2 text-sm font-medium mb-6">
            ...
            <span style={{ color: "#0A0F1E" }}>Privacy Policy</span>
          </div>

          <h1 className="text-3xl sm:text-4xl font-bold mb-2" style={{ color: "#0A0F1E" }}>Privacy Policy</h1>
          <p className="text-sm mb-10" style={{ color: "#8B90A0" }}>Effective date: January 1, 2025 · Last updated: February 2026</p>

          {/* Highlight box */}
          <div className="bg-brand-light border border-brand-200 rounded-2xl p-5 mb-10 flex gap-3">
